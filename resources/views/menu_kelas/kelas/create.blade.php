...
@section('content')
<!-- <div class="kembali">
    <a href="{{ route('kelas')}}" class="mb-2 mr-2 btn btn-primary">
        < Kembali</a>
</div>
<br> -->
...
<script>
    ...
    //CREATE
    const myForm2 = document.getElementById("nama").value;
    ...
    $('#change-pass-form').submit(function(e) {
        ...
        $("#mentor").each(function() {
            ...
            form.append("judul_kelas", document.getElementById("judul_kelas").value);
